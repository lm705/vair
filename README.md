...
📱 Как пользоваться VPN этого ПК на телефоне — [руководство](https://github.com/lm705/pc-vpn-to-phone).
...
>## Поддержка
>
>Информация о "платежных" адресах размещена в ознакомительных целях. Указанные адреса получены из открытых источников
>
>ERC20:
>
